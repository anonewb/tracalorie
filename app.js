	...
	return {
		storeItem: function(item) {
			...
			if (localStorage.getItem('items') === null) {
				...
				// LS contains some items already and is stored in strings, JSON.parse() converts it into obj
		...
		getItemsFromStorage: function() {
			//***observe the names of the fn which clearly specifies 'get the items from storage'
...
const App = (function(ItemCtrl, StorageCtrl, UICtrl) {
	...
	const itemEditClick = function(e) {
		...
		if (e.target.classList.contains('edit-item')) {
			...
			// document.querySelector(UISelectors.clearBtn).hideList;
		}
